...
print(forecast)
forecast.plot(legend=True,label="predictionSARIMA")         
plt.plot(test["Sales(in crores)"])
...
plt.plot(test["Demand(in tons)"])
plt.plot(forecast_test5,color="red")
plt.show()
...
res6.save("/Users/neerajkumar/model2.pickle")
from statsmodels.regression.linear_model import OLSResults
model7=OLSResults.load("/Users/neerajkumar/model2.pickle")
